...
type I_Avatars = 'Default' | 'Cat';

interface I_AvatarProps {
	avatarName: I_Avatars;
}

export default function Avatar({ avatarName }: I_AvatarProps) {
	// --- functions ---
	const getAvatar = () => {
		switch (avatarName) {
			case 'Default':
	...
	return (
		<div className='w-8 h-8 mr-2 rounded-full border border-gray-500 overflow-hidden flex justify-center items-center'>
			{getAvatar()}
		</div>
	);
}

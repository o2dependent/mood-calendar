...
export default function AppNav({ toggleMenu }) {
	...
	return (
		<>
			<div className='bg-red-500 w-full h-11 z-50 md:block hidden '>
				<nav className='md:mx-4 mx-2 w-100 h-full flex justify-between items-center'>
					<div
					...
					<div className='text-white flex'>
						<span className='md:inline hidden ml-auto'>
							{currentUser.email}
						</span>
			...
			<nav className='md:hidden block bg-gray-600'>
